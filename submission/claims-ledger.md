...
| Four-slot server throughput was 35.67 aggregate generated TPS versus 24.52 stock. | Measured | `docs/evidence/product-release/throughput-profile.json`; five cold servers per mode, 20 requests. Concurrent outputs were not deterministic across every run. |
